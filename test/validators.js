const Validators = artifacts.require('cache/solpp-generated-contracts/Validators.sol:Validators');
const VotePool = artifacts.require('cache/solpp-generated-contracts/mock/MockVotePool.sol:VotePool');
...
contract("Validators test", accounts => {
    ...
    it('distribute reward for burn and foundation', async () => {
        ...
        let burnReceiver = '0x000000000000000000000000000000000000DaaA'
